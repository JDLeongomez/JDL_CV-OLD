...
[\textcolor{red}{\faYoutubePlay} \textcolor{teal}{Investigación Abierta} ](https://www.youtube.com/c/InvestigaciónAbierta) es un canal de YouTube donde publico videos y tutoriales acerca de métodos y buenas práticas de investigación, estadística y ciencia abierta, así como algunos programas útiles de código abierto.
...
[\textcolor{teal}{Cortex}](https://www.journals.elsevier.com/cortex), [\textcolor{teal}{Perception}](https://journals.sagepub.com/home/pec),
[\textcolor{teal}{Evolutionary Psychology}](https://journals.sagepub.com/home/evp), y [\textcolor{teal}{Frontiers in Psychology}](https://www.frontiersin.org/journals/psychology), en donde actualmente soy *review editor* de la [\textcolor{teal}{\textit{Evolutionary Psychology specialty section}}](https://www.frontiersin.org/journals/psychology/sections/evolutionary-psychology). Mi registro verificado completo como par académico internacional está disponible en mi perfil de [\textcolor{teal}{Publons}](https://publons.com/researcher/1333339/juan-david-leongomez/).
