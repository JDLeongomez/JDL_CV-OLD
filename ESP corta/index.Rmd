...
Actualmente soy editor de un próximo número temático en [\textcolor{teal}{Philosophical Transactions B}](https://royalsocietypublishing.org/journal/rstb). Soy par revisor de diversas revistas, incuyendo [\textcolor{teal}{Proceedings of the Royal Society B}](https://royalsocietypublishing.org/journal/rspb), [\textcolor{teal}{Royal Society Open Science}](https://royalsocietypublishing.org/journal/rsos), [\textcolor{teal}{Evolution and Human Behavior}](https://www.sciencedirect.com/journal/evolution-and-human-behavior), [\textcolor{teal}{Scientific Reports}](https://www.nature.com/srep/), [\textcolor{teal}{Basic and Applied Social Psychology}](https://www.tandfonline.com/toc/hbas20/current), y [\textcolor{teal}{Frontiers in Psychology}](https://www.frontiersin.org/journals/psychology), en donde actualmente soy *review editor* de la sección especializada en [\textcolor{teal}{Psicología Evolutiva}](https://www.frontiersin.org/journals/psychology/sections/evolutionary-psychology). Mi registro verificado como par académico internacional está disponible en mi perfil de [\textcolor{teal}{Publons}](https://publons.com/researcher/1333339/juan-david-leongomez/).
