...
For a full list, and a description of responsibilities, please check [\textcolor{teal}{my website}](https://jdleongomez.info/en/#experience) or my [\textcolor{teal}{long CV}](https://jdleongomez.info/en/files/jdl_cv_en.pdf).
...
For information on **grants**, **scholarships**, **awards** and **prizes**, please check [\textcolor{teal}{my website}](https://jdleongomez.info/en/#accomplishments) or my [\textcolor{teal}{long CV}](https://jdleongomez.info/en/files/jdl_cv_en.pdf).

# Selected Publications

For a full list, please check the publications section on [\textcolor{teal}{my website}](https://jdleongomez.info/en/publication/) or my [\textcolor{teal}{long CV}](https://jdleongomez.info/en/files/jdl_cv_en.pdf).
...
For a full list, including undergraduate supervision, please check [\textcolor{teal}{my website}](https://jdleongomez.info/en/team/#students) or my [\textcolor{teal}{long CV}](https://jdleongomez.info/en/files/jdl_cv_en.pdf).
