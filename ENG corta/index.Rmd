...
I am currently serving as a guest editor of a forthcoming theme issue on [\textcolor{teal}{Philosophical Transactions B}](https://royalsocietypublishing.org/journal/rstb). I am an ad-hoc reviewer for a variety of journals including [\textcolor{teal}{Proceedings of the Royal Society B: Biological Sciences}](https://royalsocietypublishing.org/journal/rspb), [\textcolor{teal}{Royal Society Open Science}](https://royalsocietypublishing.org/journal/rsos), [\textcolor{teal}{Evolution and Human Behavior}](https://www.sciencedirect.com/journal/evolution-and-human-behavior), [\textcolor{teal}{Scientific Reports}](https://www.nature.com/srep/), [\textcolor{teal}{Basic and Applied Social Psychology}](https://www.tandfonline.com/toc/hbas20/current), and [\textcolor{teal}{Frontiers in Psychology}](https://www.frontiersin.org/journals/psychology) where I am currently a [\textcolor{teal}{Review Editor}](https://loop.frontiersin.org/people/438954/overview) for the [\textcolor{teal}{Evolutionary Psychology specialty section}](https://www.frontiersin.org/journals/psychology/sections/evolutionary-psychology).  My verified review record is available from my [\textcolor{teal}{Publons}](https://publons.com/researcher/1333339/juan-david-leongomez/) profile.
